      ...
      <div className="flex flex-col justify-center p-6 w-full max-w-4xl gap-6 raised-off-page bg-card rounded-lg">
        ...
        <div className="flex flex-col gap-3">
          <p className="text-sm text-neutral-700">
            ...
            term is defined below you agree to be bound by these terms and conditions including the
            Privacy Policy. Your agreement to be bound by these Terms and Conditions shall inure to
            the benefit of Dorado Metals Exchange LLC ("Company"), Its successors and assigns, AND
            SUPERSEDES AND REPLACES ANY INCONSISTENT STATEMENT(s) IN ANY OF OUR MATERIALS,
            ADVERTISEMENTS OR WEBSITES.
          </p>
          <p className="text-sm text-neutral-700">
            The terms “Customer,” “You,” or “Your” refer to the person or entity who engages in
            buying or selling of item(s) containing precious metals (gold, platinum, silver, or any
            combination thereof), jewelry, gemstones, bullion, industrial metals, dental or other
            personal ornaments, or any combination thereof (collectively hereinafter referred to as
            "Products") to Company for sale and purchase "We", "our", and "us" refers to Company
            (through any of its divisions or affiliates) and its employees, agents, members, owners,
            directors, officers, successors, and assigns.
          </p>
          <p className="text-sm text-neutral-700">
            By using our services, website, or engaging in transactions with us, you agree to these
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              Payments made by credit/debit card are processed securely via Stripe, Inc. Stripe may
              appear as the billing entity on your card statement
            </p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              We ship orders via insured carriers (FedEx, UPS, or USPS). You must inspect your order
              upon arrival and notify us of any issues within 24 hours. We are not responsible for
              delays due to shipping carriers or force majeure events.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              shipping procedures (“Required Shipping Procedures”). Failure to do so will negate any
              claim for loss you may make in connection with our Guarantee Against Loss or
            ...
            <ul className="list-disc ml-6 text-sm my-2 flex flex-col gap-1">
              ...
              <li className="text-neutral-700">
                Products must be securely packaged to ensure the safety of the Products either using
                the supplied materials or your own packaging.
              </li>
              <li className="text-neutral-700">
              ...
              <li className="text-neutral-700">
                The packaging should not allow the Products to be displayed or seen, do not disclose
                the Products shipped to any FedEx employee or any other person.
              </li>
              <li className="text-neutral-700">
                Ensure the Packing List provided with your label accurately states your Products and
                their value and include it with your shipment.
              </li>
              <li className="text-neutral-700">
                For contents you believe are valued at over $5,000 you must double box the shipment.
                For example, place your contents in a small FedEx box and then place that box in a
                Medium FedEx box.
              </li>
              <li className="text-neutral-700">
                If you arrange your own shipping, you shall assume any and all risk of loss and
                Company will have no liability whatsoever for your Products. In addition, you shall
                be solely responsible for shipping costs and any associated insurance.
              </li>
            </ul>
            <p className="text-sm text-neutral-700">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              or, for your convenience, we will deem the offer accepted and issue payment to you via
              company check. In general, you will receive an offer within one business day of the
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              your information to ensure the safe delivery of your Products. In addition, we reserve
              the right to make a new offer or return your Products to you in accordance with our
              Return Policy.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              ("Carrier") of our choosing. We will require a signature upon delivery. If you choose
              to receive your Products without signature, we will not be responsible for loss or
              damage to your Products. Upon delivery of returned Products by the Carrier as
              indicated by the Carrier records, the Company assumes no further liability as to the
              loss of the Products. You must notify us immediately of any change of address. We will
              not be responsible for the loss of your Products if the Carrier is unable to deliver
              to the address on file. If the carrier fails to deliver your Products and returns it
              to us, we will attempt to send the Products a second time. If Products are returned to
              us a second time, we will consider it abandoned and discard it unless you claim it
              within 30 days from the date we first attempted to mail your Products back to you.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              via: Bank Wire Transfer, ACH Transfer, Deluxe eCheck, Dorado Credit - can only be used
              in exchange for bullion products, no cash withdrawals. If you did not select a Payment
              method or if you provide us with incorrect or incomplete Payment information, we will
              issue the Payment by Deluxe eCheck. Before we issue Payment for your Products, we may
              verify the personal and payment information submitted through a national provider of
              personal identification verification services. If we are not able to verify your
              information, we may ask you for additional information or documentation, which may
              delay Payment. Please note that you are responsible for any third-party transaction
              fees relating to any Payments made by us to you or if you elect to send money back to
              us. This includes, but is not limited to, fees associated with ACH payments, Wire
              transfers and other similar payment methods. It is your responsibility to determine
              and accept any such third-party fees prior to requesting your method of Payment.
              Additional Requirements may apply depending on Payment method.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            ...
            AGREE AND UNDERSTAND THAT THE LEGAL LIMIT OF OUR LIABILITY TO YOU FOR ANY CLAIM,
          ...
          <p className="text-sm text-neutral-700">
            WE EXPRESSLY DISCLAIM ALL WARRANTIES, REPRESENTATIONS OR GUARANTEES, WHETHER EXPRESS OR
            IMPLIED NOT EXPRESSLY STATED HEREIN.
          </p>

          <div className="flex flex-col gap-1">
            <h3 className="text-lg text-neutral-900">Making a Claim</h3>
            <p className="text-sm text-neutral-700">
              If your Products has been lost or damaged in transit to or from Company and such loss
              or damage would qualify as a claim under our Guarantee Against Loss or Additional
              ...
              your Claim. Please note, due to fraud, Company shall not be liable for Products which
              are delivered in packages that are empty or missing contents since Company has no way
              of knowing if the packages were tampered, damaged or emptied before shipping Products
              for the purpose of making a Claim. Company reserves the right, in its sole discretion,
              to reject delivery of any mail, envelope or package which appears to be empty,
              damaged, opened, or tampered with, and to return such mail, envelope or package to
              you. Company shall have no liability to you for any such attempted delivery or return
              of such Products whether or not Company accepts or rejects the delivery.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-neutral-700">
              ...
              including but not limited to you and your successors, assigns, insurance carriers and
              other individuals or entities asserting any right or claim relating to your Products.
            </p>
            <p className="text-sm text-neutral-700">
              Company liability to reimburse your Products Claims shall be expressly limited to the
            ...
            <ul className="list-disc ml-6 text-sm my-2 flex flex-col gap-1">
              ...
              <li className="text-neutral-700">
                ...
                Liquidation value is defined as the value of the Products when it must be sold on an
                expedited basis.
              </li>
              <li className="text-neutral-700">
            ...
            <p className="text-sm text-neutral-700">
              Within 90 days from filed claim, Company (or the insurer if it is an insured loss) may
              in its sole discretion, either (a) reimburse you as set forth above, or (b) replace
              your Products with goods of like kind, quality, and condition.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            We are not liable for any delays or failures in performance due to circumstances beyond
            our reasonable control, including but not limited to acts of God, natural disasters,
            war, terrorism, government actions, labor strikes, supply chain disruptions, or carrier
            delays. Performance will resume as soon as the impacting event is resolved.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            If a customer fails to accept or reject an offer within 7 business days, the transaction
            is deemed accepted and payment is issued. Items returned twice due to failed delivery
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            We comply with AML (Anti-Money Laundering) regulations, Patriot Act, and IRS Form 1099-B
            reporting requirements. We cooperate with law enforcement agencies for suspicious
            transactions. We reserve the right to disclose your personally identifiable information
            upon request by a law enforcement and/or governmental agency, as required by law or when
            we believe that disclosure is necessary to protect our rights and/or to comply with a
            judicial proceeding, court order or legal process.
          </p>
          <p className="text-sm text-neutral-700">
            You must not ship hazardous or illegal materials and your shipment must otherwise comply
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            ...
            provided for in the Federal Electronic Signatures in Global and National Commerce Act or
            any similar state law based on the Uniform Electronic Transactions Act and the parties
            hereby waive any objection to the contrary. You agree that all agreements, notices,
            disclosures and other communications that are provided to you electronically satisfy any
            legal requirement that such communications be in writing.
          </p>
          <p className="text-sm text-neutral-700">
            For purposes of a Transaction, you agree that by clicking to submit on Our Website which
            relates to any agreement, acknowledgment, consent, terms, disclosures or these terms and
            conditions constitutes acceptance and agreement as if actually signed by you in writing.
            You agree and consent to be contacted by us, our agents, employees, and affiliates
            through the use of email, instant messaging or live chat, and/or telephone calls,
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            If you provide us with your mobile number, you agree that we may contact you using auto
            dialed or prerecorded message calls and text messages. The purpose of such calls or
            texts is to more efficiently provide notices regarding your Account or Transaction(s)
            ...
            dialed or prerecorded message calls or texts in order to use our services.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            ...
            same. The invalidity, in whole or in part, of any provision herein shall not affect the
            validity of the remainder of the provisions.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-neutral-700">
            DORADO METALS EXCHANGE LLC reserves the right to modify these Terms at any time. Updates
            will be posted on our website, and continued use of our services constitutes acceptance
