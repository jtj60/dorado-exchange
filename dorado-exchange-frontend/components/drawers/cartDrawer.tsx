...
const styles = {
  left: "h-full top-20 lg:top-0",
  right: "h-full top-20 lg:top-0",
};
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className={`fixed right-0 top-20 lg:top-0 z-[70] h-full w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 lg:bg-background lg:shadow-lg`}
          >
            {children}
          </motion.div>
        </>
