...
const customInputVariant = cva(
	"px-3 py-2 flex leading-4 w-full text-neutral-900 rounded-md border border-input/65 ring-offset-background bg-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-0 focus-visible:border-0 disabled:cursor-not-allowed disabled:opacity-35",
	{
		variants: {
			size: {
				xs: "h-10 text-base",
