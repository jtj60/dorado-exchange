...
const L1 = [E[0] + offsetX * unitWidth[0] + offsetY * unitDepth[0],
            E[1] + offsetX * unitWidth[1] + offsetY * unitDepth[1]];
const L2 = [L1[0] + labelWidth * unitWidth[0],
            L1[1] + labelWidth * unitWidth[1]];
const L3 = [L2[0] + labelHeight * unitDepth[0],
            L2[1] + labelHeight * unitDepth[1]];
const L4 = [L1[0] + labelHeight * unitDepth[0],
...
<polygon points="${pts([A, B, F, E])}" fill="url(#fedexFront)" stroke="#5e4322"/>

<line x1="${seamStart[0]}" y1="${seamStart[1]}" x2="${seamEnd[0]}" y2="${seamEnd[1]}"
  ...
  <!-- Length label -->
  <text x="${(B[0] + C[0]) / 2 + 10}" y="${(B[1] + C[1]) / 2 + 12}" text-anchor="middle">
    ${length} in
  </text>
...
<polygon points="${pts([E, F, G, H])}" fill="url(#cardboardTop)" stroke="#5e4322"/>
<polygon points="${pts([F, B, C, G])}" fill="url(#cardboardSide)" stroke="#5e4322"/>
<polygon points="${pts([A, B, F, E])}" fill="url(#cardboardFront)" stroke="#5e4322"/>
...
const generatePackingList = async (req, res) => {
  const { purchaseOrder, spotPrices = [], packageDetails, payoutDetails } = req.body;
  try {
...
const total =
  ...
  (purchaseOrder.shipment?.shipping_charge ?? 0) - payoutFee;
              ...
              <div class="details">
                ...
                <div class="detail-content">
                  ...
                  <div class="detail-row">
                    ...
                    <span class="detail-value"> ${
                      purchaseOrder.shipment?.shipping_charge.toLocaleString("en-US", {
                        style: "currency",
                        currency: "USD",
                      })}</span>
                  </div>
                  ...
                  <div class="detail-row">
                    ...
                    <span class="detail-value">${payoutFee.toLocaleString("en-US", {
                        style: "currency",
                        currency: "USD",
                      })}</span>
                  </div>
              ...
              <div class="step">
                ...
                <div class="package-area">
                  <div class="package-details">
                    <div class="package-details-title">${packageDetails.label}</div>
