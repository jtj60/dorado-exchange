    ...
    <div className="flex flex-col sm:flex-row items-center gap-3">
      <Chip className="bg-transparent border-0 text-white text-md" variant="faded">
        <div className="flex items-center gap-1">
          ...
          <a href="tel:+8172034786" className="text-white hover:underline block sm:hidden">
            (817) 203 - 4786
          </a>
      ...
      <Chip className="bg-transparent border-0 text-white text-md" variant="faded">
        <div className="flex items-center gap-1">
          ...
          <a href="mailto:exchange@doradometals.com" className="text-white hover:underline block sm:hidden">
